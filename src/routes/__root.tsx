  ...
  head: () => ({
    meta: [
      ...
      { title: "Maison — Mobilier & Décoration" },
      {
        name: "description",
        content:
          "Découvrez lits, bibliothèques, étagères, meubles TV, canapés et tapis premium. Mobilier moderne pour des intérieurs aérés et réfléchis.",
      },
      { name: "author", content: "Maison" },
      { property: "og:title", content: "Maison — Mobilier & Décoration" },
      {
      ...
      { name: "twitter:site", content: "@Maison" },
      {
        property: "og:image",
        content:
